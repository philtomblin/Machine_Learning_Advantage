...
namespace ml_csharp_lesson2
{
    ...
    public class Program
    {
        ...
        /// <param name="predictions">The validation_predictions to plot</param>
        /// <param name="title">The plot title</param>
        /// <param name="xAxisLabel">The x-axis label</param>
        /// <param name="yAxisLabel">The y-axis label</param>
        public static void Plot(
        ...
        public static void Main(string[] args)
        {
            ...
            Plot(training_features, training_labels, training_predictions, "Training", "Median Income", "Median house value");
            ...
            // plot the data 
            Plot(validation_features, validation_labels, validation_predictions, "Validation", "Median Income", "Median house value");
            ...
            // plot the data 
            Plot(test_features, test_labels, test_predictions, "Test", "Median Income", "Median house value");
